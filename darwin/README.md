...
- **CI Strategy**: I use the slow `macos-15-intel` runners for Darwin. macos-26-intel is the last one, but I continue to use macos-15 which is actual one for my old device.
