...
in
{
  ...
  # https://github.com/nix-community/home-manager/blob/release-25.11/modules/services/gpg-agent.nix
  services.gpg-agent = {
  ...
  # https://github.com/nix-community/home-manager/blob/release-25.11/modules/programs/gpg.nix
  programs.gpg = {
    enable = true;
  ...
  # https://github.com/nix-community/home-manager/blob/release-25.11/modules/programs/password-store.nix
