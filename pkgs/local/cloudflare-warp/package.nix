...
let
  # Because there are no PR in nixpkgs for this version, I fork this package for personal use:
  # https://nixpkgs-update-logs.nix-community.org/cloudflare-warp/2026-05-25.log
