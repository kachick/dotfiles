{ pkgs, ... }:
{
  # https://github.com/NixOS/nixpkgs/blob/nixos-26.05/nixos/modules/config/console.nix
  ...
  console = {
    ...
    # Candidates
    #   - spleen
    #   - Terminus # The bold variant is used by nixos-26.05 default
    ...
    #
    # ```bash
    # bat "$(nix build --no-link --print-out-paths github:NixOS/nixpkgs/nixos-26.05#xkeyboard_config)/etc/X11/xkb/rules/base.lst"
    # ```
    #
