{ pkgs, ... }:
{
  services.fprintd = {
    ...
    tod = {
      ...
      # https://github.com/NixOS/nixpkgs/blob/nixos-25.11/pkgs/by-name/li/libfprint-2-tod1-goodix-550a/package.nix
      # See https://github.com/ramaureirac/thinkpad-e14-linux/commit/2216fecbc7ca0a5cdd4e6bb720c4837164d9d952 for details
