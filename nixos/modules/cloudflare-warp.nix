# TODO: Replace nixpkgs official module since 24.11
# This code is imported from https://github.com/nixos/nixpkgs/blob/nixos-unstable/nixos/modules/services/networking/cloudflare-warp.nix
# to apply <https://github.com/NixOS/nixpkgs/pull/321142> for 24.05 easy
{
  config,
  lib,
  pkgs,
